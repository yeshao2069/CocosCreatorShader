import { _decorator, Component, Slider, Label, ScrollView, 
    Vec4, dynamicAtlasManager, find, Material, RenderComponent,
    UITransform, 
    Sprite} from 'cc';
    ...
    private _updateRenderComponentMaterial(param: {
        ...
        glowThreshold: number;
            ...
            this._scrollView!.content!.children.forEach((childNode) => {
                ...
                childNode.getComponent(RenderComponent)!.setMaterial(material, 0);

                if (childNode.getComponent(RenderComponent) instanceof Sprite){
