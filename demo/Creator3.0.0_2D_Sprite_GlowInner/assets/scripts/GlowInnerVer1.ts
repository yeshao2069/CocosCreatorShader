import { _decorator, Component, Slider, Label, ScrollView, Vec4, dynamicAtlasManager, find, Material, RenderComponent, Sprite } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('GlowInnerV1EffectScene')
export default class GlowInnerV1EffectScene extends Component {
