...
export class RenderQueue {
     ...
     */
    public insertRenderPass(renderObj: pipeline.IRenderObject, 
        subModelIdx: number, passIdx: number): boolean {
    ...
    public recordCommandBuffer(device: gfx.Device, renderPass: gfx.RenderPass, 
        cmdBuff: gfx.CommandBuffer) {
