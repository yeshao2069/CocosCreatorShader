...
export class SnapshotMode extends Component {
    ...
    start() {
        ...
        this.filters.unshift(new CRTFilter("NES", new Color(0.66, 1.00, 1.00), this.crtShader, 
            new PixelFilter("", Color.WHITE, this.nesShader)));
        this.filters.unshift(new CRTFilter("SNES", new Color(0.80, 1.00, 1.00), this.crtShader, 
            new PixelFilter("", Color.WHITE, this.snesShader)));
        this.filters.unshift(new BloomFilter("Bloom", Color.WHITE, this.bloomShader, 
            new BlurFilter("Blur (Full)", Color.WHITE, this.gaussianShader)));
        this.filters.unshift(new NeonFilter("Neon", Color.CYAN, this.neonShader, null!));
        this.filters.unshift(new NeonFilter("NeonBloom", Color.CYAN, this.neonShader, 
            new BloomFilter("Bloom", Color.WHITE, this.bloomShader, 
            new BlurFilter("Blur (Full)", Color.WHITE, this.gaussianShader))));
