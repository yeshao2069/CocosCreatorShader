import { _decorator, Component, Slider, Label, Node, Vec4, UIRenderable, dynamicAtlasManager, find, Material } from 'cc';
    ...
    private _updateRenderComponentMaterial(param: {
        ...
        */
        ...
        this._examplesParentNode.children.forEach(childNode => {
            childNode.getComponents(UIRenderable).forEach(renderComponent => {
